...
class Talleres extends CI_Controller {
	...
	function index()
	{
	    ...
	    $crud->set_table('rist_taller')
	        ...
	        ->columns('taller_id','usr_matricula','agenda_id','j3d8aaee0.cve_depto_adscripcion','cve_categoria','cve_delegacion','t_folio','t_fecha_registro','t_hash_constancia','t_estado')
