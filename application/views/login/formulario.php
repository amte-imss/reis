            ...
            <div class="panel">
                ...
                <div class="list-group">
                    ...
                    <div class="list-group-item">
                        ...
                        <div class="list-group-item">
                            <label for="passwd">Código de verificación:</label><br>
                            <div id="img-captcha"><?php echo $captcha['image']; ?> <!-- <a href="#" class="btn btn-lg btn-link pull-right"><span class="glyphicon glyphicon-refresh"></span></a> --></div>
