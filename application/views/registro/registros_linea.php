...
<div class="panel">
    <div class="breadcrumbs6 panel-heading" style="padding-left:10px; padding-top: 10px; padding-bottom: 10px;"><h1><small>
                <span class="glyphicon glyphicon-info-sign"></span></small> Sesiones en línea</h1>
    </div>
                        ...
                        <tbody>
                            ...
                            foreach ($sesiones_programadas_distancia as $key_sp => $sesion)
                            {
                                ...
                                if ($sesion['ontime'] == "1")
                                {
                                    ...
                                    $texto_boton = "Inscripci&oacute;n";
                                } else
                                {
                                    $tipo_boton = "btn-info";
